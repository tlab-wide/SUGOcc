...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=64052, type='CheckpointHook'),
...
mask2former_feat_channel = 32
mask2former_num_heads = 8
mask2former_num_queries = 108
mask2former_output_channel = 32
mask2former_pos_channel = 10.666666666666666
model = dict(
    dataset='nuscenes',
    do_use_history=True,
    downsample=16,
    ...
    pts_bbox_head=dict(
        ...
        norm_cfg=dict(num_groups=16, requires_grad=True, type='GN'),
...
test_dataloader = dict(
    batch_sampler=dict(batch_size=1, type='GroupInBatchSampler'),
    batch_size=1,
    dataset=dict(
...
train_cfg = dict(by_epoch=False, max_iters=6405200, val_interval=64052)
train_dataloader = dict(
    batch_sampler=dict(batch_size=4, type='GroupInBatchSampler'),
    batch_size=2,
    dataset=dict(
...
voxel_y = 0.4
voxel_z = 0.4
work_dir = './work_dirs/sugocc_nus_longterm'
